<x-app-layout>
    <div class="container mx-auto px-4 py-6">
        ...
        <h2 class="text-2xl font-bold mb-6">{{ $student->last_name }} {{ $student->first_name }} さんの実力テスト成績登録</h2>

        <form action="{{ route('hokushin-tests.store', $student->id) }}" method="POST" class="space-y-6">
            @csrf
